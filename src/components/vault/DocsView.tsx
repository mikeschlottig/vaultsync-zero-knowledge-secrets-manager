...
import { FileCode, Terminal, Github, Copy, CheckCircle2 } from 'lucide-react';
      ...
      - name: Inject Secrets
        run: |
          ...
          curl -s -H "Authorization: Bearer \${{ secrets.VAULTSYNC_TOKEN }}" \\
               "https://vaultsync.io/api/v1/fetch?env=prod" | \\
...
export $(curl -s -H "Authorization: Bearer $VAULTSYNC_TOKEN" \\
     "https://vaultsync.io/api/v1/fetch" | \\
      ...
      <section className="space-y-4">
        ...
        <div className="relative group">
          ...
          <Button 
            ...
            onClick={() => copyToClipboard(GITHUB_SNIPPET)}
          >
      ...
      <section className="space-y-4">
        ...
        <div className="relative group">
          ...
          <Button 
            ...
            size="icon" 
            className="absolute top-4 right-4 text-zinc-500 hover:text-white"
            onClick={() => copyToClipboard(DOCKER_SNIPPET)}
          >
            <Copy className="w-4 h-4" />
          </Button>
        </div>
